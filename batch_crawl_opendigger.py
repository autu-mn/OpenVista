...
def crawl_single_repo(owner: str, repo: str, max_per_month: int = 50, enable_llm: bool = True) -> bool:
    """
    爬取单个仓库的数据
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python batch_crawl_opendigger.py --count 100           # 爬取 100 个仓库
  python batch_crawl_opendigger.py --resume              # 从上次中断处继续
